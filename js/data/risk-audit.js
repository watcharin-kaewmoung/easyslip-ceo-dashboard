...
export const RISK_ITEMS = Object.freeze([
  {
    ...
    severity: 'HIGH',
    description: 'API channel คิดเป็น ~85% ของรายได้ทั้งหมด — หากสูญเสียลูกค้า API รายใหญ่ จะกระทบรุนแรง',
    descriptionEn: 'API channel accounts for ~85% of total revenue — losing a major API client would cause severe impact',
  ...
  },
  {
    ...
    severity: 'HIGH',
    description: 'ค่าระบบ ~22.9% ของรายได้ สูงกว่าเป้า 20% — หาก revenue ลด, margin จะติดลบเร็ว',
    descriptionEn: 'System cost at ~22.9% of revenue, above 20% target — if revenue drops, margin turns negative quickly',
